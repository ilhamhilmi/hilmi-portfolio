  ...
  return (
    <div>
      ...
      <header className="xl:hidden w-full z-50 fixed top-0 left-0 flex items-center justify-center px-6">
        <nav ref={menuRef} className="bg-white xl:w-3/4 w-full rounded-full px-6 py-3 mt-5 flex items-center justify-between relative">
          ...
          <div className={`bg-white absolute left-0 top-full mt-3.5 rounded-4xl w-full px-6 transition-all duration-250 ease-in-out text-center flex flex-col space-y-5 ${isOpen ? 'max-h-100 opacity-100 py-4' : 'max-h-0 opacity-0 py-0'}`}>
